...
const HeroCard = ({trendingMovie}: {trendingMovie: Movie}) => {
  return (
    ...
    <div className="flex gap-8">
        <button className=" flex items-center justify-center gap-1.5 px-4 py-3 rounded-xl cursor-pointer bg-white font-bold hover:bg-red-500 hover:text-white"><PlayCircleOutlineOutlined/>Play Now</button>
         <button className=" flex items-center justify-center gap-1.5 px-4 py-3 rounded-xl cursor-pointer bg-gray-400 font-bold hover:bg-red-500 hover:text-black text-white"><InfoOutlined/>More Info</button>
    </div>
    </div>
